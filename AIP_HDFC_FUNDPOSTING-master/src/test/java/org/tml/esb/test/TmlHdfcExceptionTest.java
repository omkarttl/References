...
public class TmlHdfcExceptionTest extends CamelSpringTestSupport {
	...
	public void testRouteException() throws Exception {
		...
		String result = "{\"error\":\"Exception Occurred while calling SAP\"}";

		assertEquals(
				"{\"error\":\"Exception Occurred while calling SAP\"}",
				result);
