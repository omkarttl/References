...
public class OrderItemsInx {
    ...
    private String trgQtyNo;
    @XmlElement(name = "TrgqtyDen")
    private String trgqtyDen;
    @XmlElement(name = "RnddlvQty")
    private String rnddlvQty;
    @XmlElement(name = "Maxdevamnt")
    private String maxdevamnt;
    @XmlElement(name = "Maxdevper")
    private String maxdevper;
    @XmlElement(name = "MaxdevDay")
    private String maxdevDay;
    ...
    private String salqtynum;
    @XmlElement(name = "Salqtyden")
    private String salqtyden;
    ...
    private String exchRateFiV;
    @XmlElement(name = "ExchgRateV")
    private String exchgRateV;
	...
	public void setExRateFi(String exRateFi) {
	...
	public void setOverdlvtol(String overdlvtol) {
	...
	public void setSalqtynum(String salqtynum) {
		this.salqtynum = salqtynum;
	}
	public String getSalqtyden() {
		return salqtyden;
	}
	public void setSalqtyden(String salqtyden) {
	...
	public void setMaxPlDlv(String maxPlDlv) {
	...
	public void setDeprecPer(String deprecPer) {
	...
	public void setExchRateFiV(String exchRateFiV) {
		this.exchRateFiV = exchRateFiV;
	}
	public String getExchgRateV() {
		return exchgRateV;
	}
	public void setExchgRateV(String exchgRateV) {
